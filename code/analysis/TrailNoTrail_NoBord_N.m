...
%              - destinations
	...
	for i = 1:20
		...
		stats = assemblyline(Gzero, Gmax, I, T, sigma, v, h, w, dests, nagent, i * 10, F, timer,...
			struct('OnlyTrail', true, 'NoVis', true, 'NoVideo', true, 'NoFireInit', true, 'NoBorder', true),...
	...
	saveas(gcf, 'output/TrailNoTrail_NoBord_N.fig', 'fig');
	print('-depsc', 'output/TrailNoTrail_NoBord_N.eps');
%end
